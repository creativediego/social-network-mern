...
export enum LikeDaoErrors {
  ...
  DB_ERROR_LIKE_TUIT = 'Database error in creating post like.',
  DB_ERROR_UNLIKE_TUIT = 'Database error in deleting post.',
  ...
  NO_TUITS_FOUND_FOR_LIKE = 'No posts found for this like',
  DB_ERROR_TUITS_BY_LIKE = 'Database error in retrieving posts by like',
  TUIT_NOT_FOUND = 'Post not found after updating likes.',
  STATS_NOT_UPDATED = 'Error updating post stats.',
}
