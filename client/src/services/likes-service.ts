...
export const findAllPostsLikedByUser = (userId: string) =>
  callAPI<IPost[]>(`${USERS_API}/${userId}/likes`, Requests.GET);

export const findAllPostsDislikedByUser = (userId: string) =>
  callAPI<IPost[]>(`${USERS_API}/${userId}/dislikes`, Requests.GET);

export const findAllUsersThatLikedPost = (tid: string) =>
  callAPI<IPost[]>(`${TUITS_API}/${tid}/likes`, Requests.GET);

export const userLikesPost = (userId: string, postId: string) =>
  callAPI<IPost>(`${USERS_API}/${userId}/posts/${postId}/likes`, Requests.POST);
